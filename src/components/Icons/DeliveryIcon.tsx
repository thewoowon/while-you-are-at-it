...
const DeliveryIcon = ({width = 24, height = 24, color = 'black'}) => (
  <Svg width={width} height={height} viewBox="0 0 25 24" fill="none">
    <Path
      ...
      fill="#C7CDD1"
    />
    <Rect x="7.5" y="8" width="2" height="1.25" rx="0.625" fill="#C7CDD1" />
    <Rect x="10.5" y="8" width="7" height="1.25" rx="0.625" fill="#C7CDD1" />
    <Rect x="10.5" y="11" width="7" height="1.25" rx="0.625" fill="#C7CDD1" />
    <Rect x="10.5" y="14" width="7" height="1.25" rx="0.625" fill="#C7CDD1" />
    <Rect x="7.5" y="11" width="2" height="1.25" rx="0.625" fill="#C7CDD1" />
    <Rect x="7.5" y="14" width="2" height="1.25" rx="0.625" fill="#C7CDD1" />
  </Svg>
);
